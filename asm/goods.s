...
_08063220:
	...
	bl __4Base
	str r6, [sp, #0x40]
	ldr r0, _080632DC @ =_vt.8UnitJoin
	str r0, [sp, #0x3c]
	ldr r2, [r4, #4]
	adds r0, r5, #0
	mov r1, sb
...
_080633A0:
	...
	bl __4Base
	str r6, [sp, #0x40]
	ldr r0, _08063470 @ =_vt.10UnitEscape
	str r0, [sp, #0x3c]
	ldr r2, [r4, #4]
	adds r0, r5, #0
	mov r1, sl
...
_0806398E:
	...
	thumb_func_start __Q27Monster9Substruct
__Q27Monster9Substruct: @ 0x08063998
